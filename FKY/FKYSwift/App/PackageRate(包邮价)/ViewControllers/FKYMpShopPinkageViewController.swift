//
//  FKYMpShopPinkageViewController.swift
//  FKY
//
...
class FKYMpShopPinkageViewController: UIViewController {
...
extension FKYMpShopPinkageViewController: UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            cell.configPackageCell(model, nowLocalTime: self.nowLocalTime,self.packageService.isCheck,false)
            //更新加车数量
...
extension FKYMpShopPinkageViewController: UIScrollViewDelegate {
    //重新设置contentoffy
