//
//  OrderExpireTipsHeadView.swift
//  FKY
//
//  Created by 寒山 on 2020/2/4.
//  Copyright © 2020 yiyaowang. All rights reserved.
//

import UIKit

class OrderExpireTipsHeadView: UIView {
    ...
    @objc func configTipView(_ tipStr: String) {
        tipLabel.attributedText = OrderExpireTipsHeadView.tipString(tipStr)
    }
    //高度
    @objc static func  configTipViewHeight(_ tipStr: String) -> CGFloat {
        let contentSize = OrderExpireTipsHeadView.tipString(tipStr).boundingRect(with: CGSize(width: SCREEN_WIDTH - WH(24), height: WH(10000)), options: .usesLineFragmentOrigin, context: nil).size
