...
class HomeTwoAdPageCell: UITableViewCell {
...
//        iv.layer.cornerRadius = WH(8)
    ...
    func setupView() {
        ...
        let space = (SCREEN_WIDTH - WH(173)*2 - WH(20))
    ...
    fileprivate func getBannerDefaultImg() -> UIImage? {
        let view = UIView.init(frame: CGRect.init(x: 0, y: 0, width: WH(173), height: WH(84)))
        view.backgroundColor = RGBColor(0xF4F4F4)
        view.layer.masksToBounds = true
        view.layer.cornerRadius = WH(4.0)
        
        let imgview = UIImageView.init(frame: CGRect.init(x: 0, y: 0, width: WH(173), height: WH(84)))
