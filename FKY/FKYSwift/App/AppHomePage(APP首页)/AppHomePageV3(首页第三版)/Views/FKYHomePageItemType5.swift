//
//  FKYHomePageItemType5.swift
//  FKY
//
//  Created by 油菜花 on 2020/10/26.
//  Copyright © 2020 yiyaowang. All rights reserved.
//  一个系统推荐站满一整行，展示4个商品 即将售罄 新品上架 本地热卖

import UIKit

class FKYHomePageItemType5: UIView {

    /// 商品点击事件
    static let productClickedAction = "FKYHomePageItemType5-productClickedAction"
    
    /// BI事件
    static let ItemBIAction = "FKYHomePageItemType5-ItemBIAction"
    
    lazy var titleBtn:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType5.titleBtnClicked), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg1:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType5.productClicked1), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg2:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType5.productClicked2), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg3:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType5.productClicked3), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg4:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType5.productClicked4), for: .touchUpInside)
        return bt
    }()
    ...
    /// 商品价格3
    lazy var productPrice3:UILabel = {
        let lb = UILabel()
        lb.font = .boldSystemFont(ofSize: WH(11))
        lb.textAlignment = .center
        lb.layer.cornerRadius = WH(13/2.0)
    ...
    /// 商品价格4
    lazy var productPrice4:UILabel = {
        let lb = UILabel()
        lb.font = .boldSystemFont(ofSize: WH(11))
        lb.textAlignment = .center
        lb.layer.cornerRadius = WH(13/2.0)
    ...
    override init(frame: CGRect) {
        ...
        priceList = [productPrice1,productPrice2,productPrice3,productPrice4]
...
//MARK: - 数据展示
extension FKYHomePageItemType5{
    /*
    func showTestData(){
    ...
    */
    ...
    func configType(){
        ...
        }else if itemModel.type == 31 {//推荐标签 搞毛专区
            configColor(subTitleTextColor: RGBColor(0x5577FB), priceTextColor: RGBColor(0x5577FB), priceBGColor: RGBColor(0xE8F1FF))
        }else{
    ...
    func configColor(subTitleTextColor:UIColor,priceTextColor:UIColor,priceBGColor:UIColor){
        ...
        productPrice3.textColor = priceTextColor
        productPrice3.backgroundColor = priceBGColor
        
        productPrice4.textColor = priceTextColor
        productPrice4.backgroundColor = priceBGColor
    }
...
extension FKYHomePageItemType5{
    ...
    @objc func titleBtnClicked(){
        let param = ["itemData":self.itemModel,"product":FKYHomePageV3FloorProductModel()]
        self.routerEvent(withName: FKYHomePageItemType5.productClickedAction, userInfo: [FKYUserParameterKey:param])
        self.routerEvent(withName: FKYHomePageItemType5.ItemBIAction, userInfo: [FKYUserParameterKey:itemModel])
    }
    
    @objc func productClicked1(){
...
extension FKYHomePageItemType5{
    ...
    func hideProductCount(productCount:Int){
        ...
        if productCount >= 1 {
            self.productImg4.isHidden = true
            self.productPrice4.isHidden = true
        }
        
        if productCount >= 2 {
            self.productImg3.isHidden = true
            self.productPrice3.isHidden = true
        }
    ...
    func showAll(){
        ...
        self.productImg3.isHidden = false
        self.productPrice3.isHidden = false
        
        self.productImg4.isHidden = false
        self.productPrice4.isHidden = false
    ...
    func setupUI(){
        ...
        addSubview(productPrice3)
        addSubview(productPrice4)
        productPrice1.backgroundColor = .red
        ...
        productImg2.snp_makeConstraints { (make) in
            ...
            make.centerY.equalTo(productImg1)
            make.width.height.equalTo(productImg1)
        }
        ...
        productImg4.snp_makeConstraints { (make) in
            make.left.equalTo(productImg3.snp_right).offset(WH(10))
            make.centerY.equalTo(productImg1)
            make.width.height.equalTo(productImg1)
        }
        ...
        productPrice3.snp_makeConstraints { (make) in
            make.left.equalTo(productImg3).offset(WH(5))
            make.right.equalTo(productImg3).offset(WH(-5))
            make.height.equalTo(WH(13))
            make.bottom.equalToSuperview().offset(WH(-10))
        }
        
        productPrice4.snp_makeConstraints { (make) in
            make.left.equalTo(productImg4).offset(WH(5))
            make.right.equalTo(productImg4).offset(WH(-5))
            make.height.equalTo(WH(13))
            make.bottom.equalToSuperview().offset(WH(-10))
        }
    }
