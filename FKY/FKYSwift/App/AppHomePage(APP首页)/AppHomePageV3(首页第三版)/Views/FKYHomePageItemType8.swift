...
class FKYHomePageItemType8: UIView {
    
    /// 商品1点击事件
    static let productClickedAction = "FKYHomePageItemType8-productClickedAction"
    
//    /// 商品2点击事件
//    static let product2ClickedAction = "FKYHomePageItemType8-product2ClickedAction"
//
//    /// 商品3点击事件
//    static let product3ClickedAction = "FKYHomePageItemType8-product3ClickedAction"
//
//    /// 商品4点击事件
//    static let product4ClickedAction = "FKYHomePageItemType8-product4ClickedAction"
    ...
    lazy var productImg1:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType8.product1Clicked), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg2:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType8.product2Clicked), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg3:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType8.product3Clicked), for: .touchUpInside)
        return bt
    }()
    ...
    lazy var productImg4:UIButton = {
        let bt = UIButton()
        bt.addTarget(self, action: #selector(FKYHomePageItemType8.product4Clicked), for: .touchUpInside)
        return bt
    }()
...
//MARK: - 数据展示
extension FKYHomePageItemType8{
...
extension FKYHomePageItemType8{
    ...
    override func routerEvent(withName eventName: String!, userInfo: [AnyHashable : Any]! = [:]) {
        if eventName == FKYHomePageSectionTypeTagView.tagClickAction{
            ...
            self.routerEvent(withName: FKYHomePageItemType8.productClickedAction, userInfo: [FKYUserParameterKey:param])
        }else{
...
extension FKYHomePageItemType8{
    ...
    func setupUI(){
        ...
        productImg1.snp_makeConstraints { (make) in
            make.left.equalToSuperview().offset(WH(14))
            make.right.equalTo(productImg2.snp_left).offset(WH(-5))
        ...
        linePrice3.snp_makeConstraints { (make) in
            //make.left.right.equalTo(productImg3)
            make.centerX.equalTo(productImg3)
        ...
        linePrice4.snp_makeConstraints { (make) in
            //make.left.right.equalTo(productImg4)
            make.centerX.equalTo(productImg4)
