...
class FKYNativeRouterOCObject: NSObject {
    //MARK: 首页模式轮播banner之查看详情
    static func jumpBannerDetailActionWithAll(jumpType: Int?, jumpInfo: String?, jumpExpandOne: String?, jumpExpandTwo: String?) {
    ...
    //MARK: 跳转商详页
    static  func jumpProductDetail(productCode: String?, productSupplyId: String?) {
    ...
    @objc static func visitSchema(_ schema: String) {
